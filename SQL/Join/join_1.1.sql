/*
* Есть несколько человек с одинаковым временем ожидания. Даже если учитывать секунды, то ничего не поменяется 
* ведь часы/минуты/секунды у каждого заказа совпадают для отправки и получения
*/
